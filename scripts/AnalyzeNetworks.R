...
png(filename = paste0("output/Networks/SignedIntMat_", filename, ".png"), width = 5, height = 2.5, units = "in", res = 600)
multiplot(plotlist = interaction_sign_graphs, layout = matrix(c(seq(1:length(interaction_graphs))), nrow=2, byrow=TRUE))
dev.off()

png(filename = paste0("output/Networks/FIGURE_SignedIntMat_Single_", filename, ".png"), width = 2, height = 2, units = "in", res = 600)
...
# Subset of graphs plot for figure
png(filename = paste0("output/Networks/FIGURE_SignedIntMat_", filename, ".png"), width = 4, height = 1, units = "in", res = 600)

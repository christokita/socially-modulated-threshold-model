...
write.csv(edgelist, file = "output/Networks/GroupSize70edgelistFIXED.csv", row.names = FALSE)
write.csv(nodelist, file = "output/Networks/GroupSize70nodelistFIXED.csv", row.names = FALSE)

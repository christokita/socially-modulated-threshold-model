...
epsilons       <- seq(0, 0.6, 0.01) #relative weighting of social interactions for adjusting thresholds
...
dir_name <- paste0("n", n,  "-Sigma", (ThreshSD/ThreshM)[1], "-Beta", beta, "_EpsSweep-HighThreshLimit")
...
run_in_parallel <- expand.grid(epsilon = epsilons, run = chunk_run)

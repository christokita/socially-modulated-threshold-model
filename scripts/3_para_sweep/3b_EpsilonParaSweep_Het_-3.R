...
epsilons       <- seq(-0.35, -0.225, 0.025) #relative weighting of social interactions for adjusting thresholds
beta           <- 0.9 #probability of interacting with individual in same state relative to others
...
sfLibrary(tidyr)
sfLibrary(stringr)
# sfClusterSetupRNGstream(seed = 000)

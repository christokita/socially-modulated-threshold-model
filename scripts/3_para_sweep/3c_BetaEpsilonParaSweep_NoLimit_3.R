...
betas          <- seq(1.10, 1.14, 0.01) #probability of interacting with individual in same state relative to others
...
file_name <- paste0("EpsilonBetaSweep_NoThreshLimit_Sigma", ThreshSD[1], "-n", n)

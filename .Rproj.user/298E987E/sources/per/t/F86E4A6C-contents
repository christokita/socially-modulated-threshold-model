...
fix_groups_graphs_sigma05 <- groups_graphs
fix_groups_threshMat_sigma05 <- groups_thresh

# Load fixed: sigma 01
load("output/Rdata/Sigma0.01-FIXED-Bias1.1.Rdata")

fix_groups_graphs_sigma01 <- groups_graphs
fix_groups_threshMat_sigma01 <- groups_thresh

####################
# Plot Signed Interaction Matrix Plot
####################
...
###### Fixed Sigma 01 ###### 
# Only color by significantly different than random
type_groups_graphs <- fix_groups_graphs_sigma01
type_groups_threshMat <- fix_groups_threshMat_sigma01
